  ...
  return (
    <div className="max-w-7xl mx-auto space-y-3 font-mono">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 bg-slate-900/60 border border-slate-800 rounded-xl p-3.5 shadow-lg text-slate-200">
        <div>
          <h2 className="font-bold text-xs uppercase tracking-wider text-blue-400 flex items-center gap-1.5 font-mono">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-blue-400 text-[10px] font-bold uppercase flex items-center gap-1 border border-slate-700 transition-all"
          ...
          <button
            ...
            className="px-2.5 py-1 rounded bg-blue-600 hover:bg-blue-500 text-white text-[10px] font-bold uppercase flex items-center gap-1 shadow-sm transition-all"
          >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
        <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-3 shadow-lg">
